...
<h2>yor email {{$email}}</h2>
  <a href="http://localhost:8000/virefiy_email/{{$href}}">virefie</a>
</div>
...
<body style="background-color: black ; width: 60%;margin: 10px auto;">
  ...
  <a href="http://localhost:8000/virefiy_email/{{$href}}" style="padding: 10px 29px;;border: 1px solid #d18e2a;color:#d18e2a;background-color: black;border-radius: 10px;text-decoration: none;">Verifier Email</a>
